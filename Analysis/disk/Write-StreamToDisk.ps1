...
.\Write-StreamToDisk.ps1 -memstream $(Import-CSV -Path C:\Powershell\Kansa\Output_20180108143506\FileCUsersappetmprodAppDataLocalTemp1e.exe\TestComputer-FileCUsersappuserAppDataLocalTemp1e.exe.csv).content -outputloc C:\Temp\test.exe
